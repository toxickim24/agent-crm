...
import { Users, TrendingUp, Award, AlertCircle, Search, Eye, X, RefreshCw, ChevronLeft, ChevronRight } from 'lucide-react';
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              {/* Attributes */}
              <div>
                <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Attributes</label>
                <div className="mt-2 bg-gray-50 dark:bg-gray-900 rounded-lg p-3 max-h-60 overflow-y-auto">
                  <pre className="text-sm text-gray-900 dark:text-white whitespace-pre-wrap">
                    {JSON.stringify(formatAttributes(selectedContact.attributes), null, 2)}
                  </pre>
                </div>
              </div>
